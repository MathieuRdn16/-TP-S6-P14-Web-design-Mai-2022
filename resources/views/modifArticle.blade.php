    ...
    <div class="container px-6 mx-auto grid">
            ...
            >
                <label class="block text-sm">
                    ...
                    <input
                        ...
                        name="titre" type="text" value="{{$article->titre}}"
                    />
                </label>
                <label class="block text-sm">
                <span class="text-gray-700 dark:text-gray-400">Image</span>
                <img src="{{$article->image}}" id="image"/>
                <input
                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                         type="file" id="formFile"
                />
                <input  type="hidden" id="base64" name="image" value="{{$article->image}}">
            </label>
        ...
        <span class="text-gray-700 dark:text-gray-400">
          Categorie
                    ...
                    >
                        <option value="{{$article->Categorie->idcat }}">{{$article->Categorie->designation }}</option>
                ...
                <label class="block mt-4 text-sm">
                    ...
                    <textarea
                        ...
                        rows="3" name="resume"
                    >{{$article->resume}}</textarea>
                </label>
                <br>
                <label class="block mt-4 text-sm">
                    <span class="text-gray-700 dark:text-gray-400">Contenu</span>
                    <textarea class="form-control" id="summary-ckeditor" name="contenu" >{{$article->contenu}}</textarea>
                </label>
                <br>
